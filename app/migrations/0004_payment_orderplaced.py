    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Accepted', 'Accepted'), ('pending', 'pending'), ('delivered', 'delivered'), ('on the way', 'on the way'), ('packed', 'packed')], default='pending', max_length=50)),
